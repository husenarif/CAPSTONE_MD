...
//import com.exemple.capstone.activity.ui.helper.ImageClassifierHelper
//import com.exemple.capstone.databinding.ActivityResultBinding
...
//            } else {
//                showToast("Tidak ada Gambar hasil analisa")
//                finish()
//            }
//        }
//    }
...
//        Log.d(TAG, "Menampilkan Gambar: $uri")
...
//                    Log.d(TAG, "Hasil prediksi berhasil disimpan: $prediction")
//                    val predictions = database.predictionHistoryDao().getAllPredictions()
//                    Log.d(TAG, "Semua hasil prediksi: $predictions")
//                    moveToHistory(destinationUri, result)
//                } catch (e: Exception) {
//                    Log.e(TAG, "Gagal menyimpan hasil prediksi: $prediction", e)
//                }
//            }
//        } else {
//            Log.e(TAG, "Hasil kosong, tidak dapat menyimpan ke Database.")
//        }
//    }
//
